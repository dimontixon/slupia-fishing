  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className="pointer-events-none block size-4 translate-x-0.5 rounded-full bg-background shadow-xs transition-transform data-checked:translate-x-[calc(100%-2px)] dark:bg-foreground"
      />
    </SwitchPrimitive.Root>
  )
}
