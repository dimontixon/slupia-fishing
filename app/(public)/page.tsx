    ...
    <>
      <div className="bg-accent-warm">
        <div className="mx-auto flex max-w-5xl flex-col items-center gap-3 px-4 py-12 text-center">
          ...
          <h1 className="font-heading text-3xl font-semibold text-accent-warm-foreground">
            Łowisko Komercyjne &quot;Słupia&quot;
          </h1>
          <p className="text-accent-warm-foreground/75">
      ...
      <main className="mx-auto flex max-w-5xl flex-1 flex-col gap-10 px-4 py-10">
        <div className="flex justify-end">
          <Link href="/kalendarz" className="text-sm font-medium text-primary hover:underline">
            Zobacz kalendarz dostępności →
          </Link>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          {TEASERS.map((teaser) => (
            <Link key={teaser.href} href={teaser.href}>
              <Card className="h-full ring-primary/15 transition-colors hover:bg-muted/50">
                <CardHeader>
